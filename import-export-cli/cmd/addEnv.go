...
var	flagStoreEndpoint string		   // store endpoint of the environment to be added
...
func executeAddEnvCmd(mainConfigFilePath string) {
	...
	envEndpoints.StoreEndpoint = flagStoreEndpoint
...
func init() {
	...
	addEnvCmd.Flags().StringVar(&flagStoreEndpoint, "store", "", "Store endpoint for the environment")
}
